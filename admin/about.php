...
<div class="flex max-w-7xl mx-auto mt-8 px-4">
  ...
  <aside class="w-1/4 bg-white dark:bg-gray-800 rounded shadow p-4">
    ...
    <ul class="space-y-2 text-gray-700 dark:text-gray-300">
      ...
      <li><a href="about.php" class="block font-semibold text-blue-800 dark:text-blue-300">About</a></li>
      <li>
  ...
  <main class="w-3/4 bg-white dark:bg-gray-800 rounded shadow p-6 ml-6">
    <div class="flex justify-between items-center mb-4">
      ...
      <a href="add_about.php" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">
        + Tambah Data
      </a>
    </div>
    <div class="space-y-4">
      ...
      while ($data = mysqli_fetch_array($query)) {
        ...
        echo "<a href='edit_about.php?id_about={$data['id_about']}' class='text-blue-600 dark:text-blue-400 hover:underline'>Edit</a>";
