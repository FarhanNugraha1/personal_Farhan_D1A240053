...
<body class="bg-gray-100 dark:bg-gray-900 min-h-screen text-gray-800 dark:text-gray-100 transition-colors duration-300">
  <!-- Header -->
  <header class="bg-blue-900 dark:bg-gray-800 text-white py-6 shadow relative">
    <h1 class="text-3xl font-bold text-center">Tambah Data About</h1>
    <div class="absolute right-8 top-1/2 transform -translate-y-1/2 flex space-x-2">
      <button id="toggleDark" class="bg-blue-600 text-white px-4 py-2 rounded shadow hover:bg-blue-700 transition">Dark Mode</button>
      <button id="toggleRed" class="bg-red-700 text-white px-4 py-2 rounded shadow hover:bg-red-800 transition">Red Mode</button>
    </div>
  </header>
    ...
    <main class="w-3/4 bg-white dark:bg-gray-800 rounded shadow p-6 ml-6">
      <form action="proses_add_about.php" method="post" class="space-y-6">
        <div>
          ...
          <textarea id="about" name="about" rows="5" required class="w-full p-2 border rounded focus:outline-none focus:ring focus:border-blue-500 dark:bg-gray-700 dark:text-gray-100 dark:border-gray-600"></textarea>
        </div>
        <div class="flex justify-end space-x-4">
          <button type="submit" class="bg-blue-700 text-white px-4 py-2 rounded hover:bg-blue-800 transition">Simpan</button>
          <a href="about.php" class="bg-gray-300 dark:bg-gray-600 text-gray-700 dark:text-gray-100 px-4 py-2 rounded hover:bg-gray-400 dark:hover:bg-gray-500 transition">Batal</a>
        </div>
      </form>
    </main>
  </div>
  ...
  <footer class="bg-blue-800 dark:bg-gray-800 text-white text-center py-4 mt-10">
    &copy; <?php echo date('Y'); ?> | Created by Farhan Nugraha
  </footer>
